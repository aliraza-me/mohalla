...
<div class="product_meta">
	...
	<?php if ( in_array( 'sku', $product_extra ) ) { ?>
		<?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
			...
			<span class="sku_wrapper"><?php esc_html_e( 'SKU:', 'mrbara' ); ?>
				<span class="sku"><?php echo ( $sku = $product->get_sku() ) ? $sku : esc_html__( 'N/A', 'mrbara' ); ?></span></span>
	...
	<?php if ( in_array( 'categories', $product_extra ) ) {
		if ( function_exists( 'wc_get_product_category_list' ) ) {
			...
			echo $product->get_categories( '<span>,</span> ', '<span class="posted_in"><label>' . _n( 'Category:', 'Categories:', $cat_count, 'mrbara' ) . '</label> ', '</span>' );
		}
	}
	?>
	...
	<?php if ( in_array( 'tags', $product_extra ) ) {
		if ( function_exists( 'wc_get_product_tag_list' ) ) {
			...
			echo $product->get_tags( '<span>,</span> ', '<span class="tagged_as"><label>' . _n( 'Tag:', 'Tags:', $tag_count, 'mrbara' ) . '</label> ', '</span>' );
		}
	} ?>
