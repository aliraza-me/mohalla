...
class MrBara_Mega_Menu_Edit {
	...
	public function scripts( $hook ) {
		...
		wp_register_style( 'mrbara-mega-font-ionicons', get_template_directory_uri() . '/css/ionicons.min.css', array(), '2.0' );
		wp_register_style( 'mrbara-mega-font-linearicons', get_template_directory_uri() . '/css/linearicons.css', array(), '1.0' );
		wp_register_style( 'mrbara-mega-menu', get_template_directory_uri() . '/inc/mega-menu/css/mega-menu.css', array( 'media-views', 'wp-color-picker', 'mrbara-mega-font-ionicons', 'mrbara-mega-font-linearicons' ), '20160530' );
