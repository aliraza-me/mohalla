...
(function($) {
	...
	FlipClock.Time = FlipClock.Base.extend({
		...
		/**
		 * Gets an MR hourly breakdown
		 *
		 * @return  object  Returns a digitized object
		 */

		getMRDailyCounter: function() {
...
(function($) {
	...
	FlipClock.DailyCounterFace = FlipClock.Face.extend({
		...
		build: function(time) {
			...
			time = time ? time : this.factory.time.getMRDailyCounter();
		...
		flip: function(time, doNotAddPlayClass) {
			if(!time) {
				time = this.factory.time.getMRDailyCounter();
			}
...
(function($) {
	...
	FlipClock.HourlyCounterFace = FlipClock.Face.extend({
		...
		build: function(excludeHours, time) {
			...
			time = time ? time : this.factory.time.getMRHourlyCounter();
		...
		flip: function(time, doNotAddPlayClass) {
			if(!time) {
				time = this.factory.time.getMRHourlyCounter();
			}
