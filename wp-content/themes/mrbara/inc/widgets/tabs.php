...
class MrBara_Tabs_Widget extends WP_Widget {
	/**
	 ...
	 * Set up the widget
	 *
	 * @return MrBara_Tabs_Widget
	 */
	function __construct() {
		$this->defaults = array(
			'popular_show'       => 1,
			'popular_title'      => esc_html__( 'Popular', 'mrbara' ),
			'popular_limit'      => 5,
			'popular_thumb'      => 1,
			'popular_thumb_size' => 'widget-thumb',
			'popular_date'       => 1,
			'recent_show'        => 1,
			'recent_title'       => esc_html__( 'Recent', 'mrbara' ),
			'recent_limit'       => 5,
			'recent_thumb'       => 1,
			'recent_thumb_size'  => 'widget-thumb',
			'recent_date'        => 1,
			'comments_show'      => 1,
			'comments_title'     => esc_html__( 'Comments', 'mrbara' ),
			'comments_limit'     => 5,
		);

        parent::__construct(
			'tabs-widget',
	        esc_html__( 'MrBara - Tabs', 'mrbara' ),
			array(
				'classname'   => 'tabs-widget',
				'description' => esc_html__( 'Display most popular posts, recent posts, recent comments in tabbed widget.', 'mrbara' ),
			),
			array( 'width' => 780 )
		);
			...
			<div class="tab-popular-posts tabs-panel active">
				...
				while ( $popular_posts->have_posts() ): $popular_posts->the_post(); ?>
					...
					<article class="popular-post <?php echo esc_attr( $class ) ?>">
						...
						?>
						<div class="post-text">
							<a class="post-title" href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'mrbara' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
							<?php
		...
		if ( $instance['comments_show'] ) {
			...
			foreach ( $comments as $comment ) {
				echo sprintf(
					...
					esc_html__( 'by', 'mrbara' ),
					$comment->comment_author,
					esc_html__( 'on', 'mrbara' ),
	...
	function form( $instance ) {
		...
		?>
		<div class="mr-tab-box">
			<p><strong><?php esc_html_e( 'Popular Posts', 'mrbara' ); ?></strong></p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'popular_show' ) ); ?>"><?php esc_html_e( 'Show Popular Tab', 'mrbara' ); ?></label>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'popular_title' ) ); ?>"><?php esc_html_e( 'Title', 'mrbara' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'popular_limit' ) ); ?>"><?php esc_html_e( 'Number Of Posts', 'mrbara' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'popular_date' ) ); ?>"><?php esc_html_e( 'Show Date', 'mrbara' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'popular_thumb' ) ); ?>"><?php esc_html_e( 'Show Thumbnail', 'mrbara' ); ?></label>
			</p>

			<?php if ( method_exists( 'MrBara_Recent_Posts_Widget', 'get_image_sizes' ) ) : ?>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'popular_thumb_size' ) ); ?>"><?php esc_html_e( 'Thumbnail Size', 'mrbara' ); ?></label>
					<select name="<?php echo esc_attr( $this->get_field_name( 'popular_thumb_size' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'popular_thumb_size' ) ); ?>" class="widefat">
						<?php foreach ( $sizes = MrBara_Recent_Posts_Widget::get_image_sizes() as $name => $size ) : ?>
		...
		<div class="mr-tab-box">
			<p><strong><?php esc_html_e( 'Recent Posts', 'mrbara' ); ?></strong></p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'recent_show' ) ); ?>"><?php esc_html_e( 'Show Recent Posts Tab', 'mrbara' ); ?></label>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'recent_title' ) ); ?>"><?php esc_html_e( 'Title', 'mrbara' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'recent_limit' ) ); ?>"><?php esc_html_e( 'Number Of Posts', 'mrbara' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'recent_date' ) ); ?>"><?php esc_html_e( 'Show Date', 'mrbara' ); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'recent_thumb' ) ); ?>"><?php esc_html_e( 'Show Thumbnail', 'mrbara' ); ?></label>
			</p>

			<?php if ( method_exists( 'MrBara_Recent_Posts_Widget', 'get_image_sizes' ) ) : ?>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'recent_thumb_size' ) ); ?>"><?php esc_html_e( 'Thumbnail Size', 'mrbara' ); ?></label>
		...
		<div class="mr-tab-box last">
			<p><strong><?php esc_html_e( 'Recent Comments', 'mrbara' ); ?></strong></p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'comments_show' ) ); ?>"><?php esc_html_e( 'Show Recent Posts Tab', 'mrbara' ); ?></label>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'comments_title' ) ); ?>"><?php esc_html_e( 'Title', 'mrbara' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'comments_limit' ) ); ?>"><?php esc_html_e( 'Number of comments to show', 'mrbara' ); ?></label>
			</p>
		</div>
		<div class="clear"></div>
	<?php
